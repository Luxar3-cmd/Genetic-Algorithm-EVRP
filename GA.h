...
class evolutionaryAlgo {
    public: 
        ...
        // =============================================
        // === Datos para evaluación de la población ===
        // =============================================
    ...
    private:
        ...
        bool verify_route_battery_exact(const Route& route) const;
        ...
        // ====================================================
        // ===== Conjunto de Nodos para preprocesado ==========
        // ====================================================
         ...
         */
        Solution reconstruct_solution_from_split(const vector<int>& chromosome, const vector<double>& V, const vector<int>& Pred, int n) const;
